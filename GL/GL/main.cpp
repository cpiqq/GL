...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		GLuint projecLoc = glGetUniformLocation(ourShader.Program, "projection");
		...
		for (GLuint i = 0; i < 10; i++)
		{
			...
			GLfloat ang =  glm::radians(20.0f) * i;
			if (i == 1 || i == 3)
			{
				ang = glfwGetTime()* glm::radians(20.0f) * i;
			}
			model = glm::rotate(model, ang, glm::vec3(1.0f, 0.3f, 0.5f));
